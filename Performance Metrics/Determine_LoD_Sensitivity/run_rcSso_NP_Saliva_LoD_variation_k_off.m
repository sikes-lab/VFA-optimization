rcSso_NP_Swab_LoD_variation_k_off(0.02)

function rcSso_NP_Swab_LoD_variation_k_off(Visual_LoD)
...
plot(k_offs,LoD_All,'LineWidth',1.5)
xlabel('k_{off} (s^{-1})'); ylabel('LoD (nM)');
ax = gca;
ax.FontSize = 12;
%lgd.FontSize = 12;
...
saveas(gcf,'rcSso_NP_Saliva_vary_k_off_LoD_changes.fig')
save('Change_k_off_Saliva_LoD.mat','k_offs','LoD_All');
