rcSso_NP_Saliva_SN_variation_Rep_Conc(5e-9.*1e3)

function rcSso_NP_Saliva_SN_variation_Rep_Conc(Probe_Conc)
...
yyaxis left;
plot(Rep_Concs,SoverN,'Color','b','LineWidth',1.5); 
ylabel('S/N Ratio');
yyaxis right;
plot(Rep_Concs,SminusN,'Color','r','LineWidth',1.5);
ylabel('(S-N) (AU)');
xlabel('[Reporter] (nM)');
...
saveas(gcf,'rcSso_NP_Saliva_vary_Rep_SN_changes.fig')
save('Change_Rep_Conc_Saliva_SN.mat','Rep_Concs','S_All','N_All','SoverN','SminusN');
