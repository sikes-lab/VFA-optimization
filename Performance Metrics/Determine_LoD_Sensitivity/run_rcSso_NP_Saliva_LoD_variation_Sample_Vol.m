rcSso_NP_Saliva_LoD_variation_Sample_Vol(0.02)

function rcSso_NP_Saliva_LoD_variation_Sample_Vol(Visual_LoD)
...
LoD_All = zeros(size(Sample_Vols));
...
plot(Sample_Vols,LoD_All,'LineWidth',1.5)
xlabel('Sample Volume (\muL)'); ylabel('LoD (nM)');
ax = gca;
ax.FontSize = 12;
%lgd.FontSize = 12;
...
saveas(gcf,'rcSso_NP_Saliva_vary_SampleVol_LoD_changes.fig')
save('Change_Sample_Vols_Saliva_LoD.mat','Sample_Vols','LoD_All');
