rcSso_NP_Saliva_SN_variation_Sample_Vol(5e-9.*1e3)

function rcSso_NP_Saliva_SN_variation_Sample_Vol(Probe_Conc)
...
yyaxis left;
plot(Sample_Vols,SoverN,'Color','b','LineWidth',1.5); 
ylabel('S/N Ratio');
yyaxis right;
plot(Sample_Vols,SminusN,'Color','r','LineWidth',1.5);
ylabel('(S-N) (AU)');
xlabel('Sample Volume (\muL)');
...
saveas(gcf,'rcSso_NP_Saliva_vary_SampleVol_SN_changes.fig')
save('Change_SampleVol_Saliva_SN.mat','Sample_Vols','S_All','N_All','SoverN','SminusN');
