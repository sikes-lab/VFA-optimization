rcSso_NP_Swab_LoD_variation_IncubTime(0.02)

function rcSso_NP_Swab_LoD_variation_IncubTime(Visual_LoD)
...
plot(IncubTimes,LoD_All,'LineWidth',1.5)
xlabel('Incubation Time (s)'); ylabel('LoD (nM)');
ax = gca;
ax.FontSize = 12;
%lgd.FontSize = 12;
...
saveas(gcf,'rcSso_NP_Saliva_vary_IncubTime_LoD_changes.fig')
save('Change_IncubTime_Saliva_LoD.mat','IncubTimes','LoD_All');
