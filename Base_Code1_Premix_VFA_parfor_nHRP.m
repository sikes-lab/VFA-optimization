function n_HRP = Premix_VFA_parfor_nHRP(c_analyte,Soln_pptys,Paper_params,op_params,M,N,InletBC,param_pt)
...
if strcmp(MixingFormat,'Premix') 
    ...
    c0 = [Soln_pptys(param_pt,9) 0 0 0 0 Soln_pptys(param_pt,8)].*op_params{param_pt,6}; % Premixing concentration Dilution X of final
...
op_params{param_pt,3} = C_NS_targets.*op_params{param_pt,7}; %initialize sample_conc
...
k_on_SA = (4.5e7/1e4)*1e-3; %[M^-1 s^-1] For 1 SA to BA
k_off_SA = 5.2e-6; %[s^-1]
...
r2 = (1e4)*k_on_SA*C(2)*C(3) - k_off_SA*C(5); % (2) Binder-BA + (3) SA-HRP -> (5) Binder-BA-SA-HRP
r3 = (1e4)*k_on_SA*C(4)*C(3) - k_off_SA*C(18); % (4) NP-Binder-BA + (3) SA-HRP -> (18) NP-Binder-BA-SA-HRP
r4 = k_on_Binder*C(1)*C(5) - k_off_Binder*C(18); % (1) NP + (5) Binder-BA-SA-HRP -> (18) NP-Binder-BA-SA-HRP

r5 = (1e3)*k_on_SA*C(2)*C(5) - 2*k_off_SA*C(6); % (5) Binder-BA-SA-HRP + (2) Binder-BA -> (6) Binder-BA(2)-SA-HRP
r6 = (1e2)*k_on_SA*C(2)*C(6) - 3*k_off_SA*C(7); % (6) Binder-BA(2)-SA-HRP + (2) Binder-BA -> (7) Binder-BA(3)-SA-HRP
r7 = (1e1)*k_on_SA*C(2)*C(7) - 4*k_off_SA*C(8); % (7) Binder-BA(3)-SA-HRP + (2) Binder-BA -> (8) Binder-BA(4)-SA-HRP
...
r11 = k_on_Binder*C(1)*C(9) - 2*k_off_Binder*C(12); % (1) NP + (9) NP-Binder-BA(2)-SA-HRP -> (12) NP(2)-Binder-BA(2)-SA-HRP
r12 = 2*k_on_Binder*C(1)*C(10) - 2*k_off_Binder*C(13); % (1) NP + (10) NP-Binder-BA(3)-SA-HRP -> (13) NP(2)-Binder-BA(3)-SA-HRP
r13 = 3*k_on_Binder*C(1)*C(11) - 2*k_off_Binder*C(14); % (1) NP + (11) NP-Binder-BA(4)-SA-HRP -> (14) NP(2)-Binder-BA(4)-SA-HRP

r14 = k_on_Binder*C(1)*C(13) - 3*k_off_Binder*C(15); % (1) NP + (13) NP(2)-Binder-BA(3)-SA-HRP -> (15) NP(3)-Binder-BA(3)-SA-HRP
r15 = 2*k_on_Binder*C(1)*C(14) - 3*k_off_Binder*C(16); % (1) NP + (14) NP(2)-Binder-BA(4)-SA-HRP -> (16) NP(3)-Binder-BA(4)-SA-HRP

r16 = k_on_Binder*C(1)*C(16) - 4*k_off_Binder*C(17); % (1) NP + (16) NP(3)-Binder-BA(4)-SA-HRP -> (17) NP(4)-Binder-BA(4)-SA-HRP

r17 = (1e3)*k_on_SA*C(4)*C(5) - k_off_SA*C(9); % (4) NP-Binder-BA + (5) Binder-BA-SA-HRP -> (9) NP-Binder-BA(2)-SA-HRP
r18 = (1e2)*k_on_SA*C(4)*C(6) - k_off_SA*C(10); % (4) NP-Binder-BA + (6) Binder-BA(2)-SA-HRP -> (10) NP-Binder-BA(3)-SA-HRP
r19 = (1e1)*k_on_SA*C(4)*C(7) - k_off_SA*C(11); % (4) NP-Binder-BA + (7) Binder-BA(3)-SA-HRP -> (11) NP-Binder-BA(4)-SA-HRP

r20 = (1e3)*k_on_SA*C(4)*C(18) - 2*k_off_SA*C(12); % (4) NP-Binder-BA + (9) NP-Binder-BA-SA-HRP -> (12) NP(2)-Binder-BA(2)-SA-HRP
r21 = (1e2)*k_on_SA*C(4)*C(9) - 2*k_off_SA*C(13); % (4) NP-Binder-BA + (10) NP-Binder-BA(2)-SA-HRP -> (13) NP(2)-Binder-BA(3)-SA-HRP
r22 = (1e1)*k_on_SA*C(4)*C(10) - 2*k_off_SA*C(14); % (4) NP-Binder-BA + (11) NP-Binder-BA(3)-SA-HRP -> (14) NP(2)-Binder-BA(4)-SA-HRP

r23 = (1e2)*k_on_SA*C(4)*C(12) - 3*k_off_SA*C(15); % (4) NP-Binder-BA + (12) NP(2)-Binder-BA(2)-SA-HRP -> (15) NP(3)-Binder-BA(3)-SA-HRP
r24 = (1e1)*k_on_SA*C(4)*C(13) - 3*k_off_SA*C(16); % (4) NP-Binder-BA + (13) NP(2)-Binder-BA(3)-SA-HRP -> (16) NP(3)-Binder-BA(4)-SA-HRP

r25 = (1e1)*k_on_SA*C(4)*C(15) - 4*k_off_SA*C(17); % (4) NP-Binder-BA + (15) NP(3)-Binder-BA(3)-SA-HRP -> (17) NP(4)-Binder-BA(4)-SA-HRP

r26 = (1e3)*k_on_SA*C(2)*C(18) - 1*k_off_SA*C(9); % (2) Binder-BA + (18) NP-Binder-BA-SA-HRP -> (9) NP-Binder-BA(2)-SA-HRP
r27 = (1e2)*k_on_SA*C(2)*C(9) - 2*k_off_SA*C(10); % (2) Binder-BA + (9) NP-Binder-BA(2)-SA-HRP -> (10) NP-Binder-BA(3)-SA-HRP
r28 = (1e1)*k_on_SA*C(2)*C(10) - 3*k_off_SA*C(11); % (2) Binder-BA + (10) NP-Binder-BA(3)-SA-HRP -> (11) NP-Binder-BA(4)-SA-HRP

r29 = (1e2)*k_on_SA*C(2)*C(12) - k_off_SA*C(13); % (2) Binder-BA + (12) NP(2)-Binder-BA(2)-SA-HRP -> (13) NP(2)-Binder-BA(3)-SA-HRP
r30 = (1e1)*k_on_SA*C(2)*C(13) - k_off_SA*C(14); % (2) Binder-BA + (13) NP(2)-Binder-BA(3)-SA-HRP -> (14) NP(2)-Binder-BA(4)-SA-HRP
r31 = (1e1)*k_on_SA*C(2)*C(15) - k_off_SA*C(16); % (2) Binder-BA + (15) NP(3)-Binder-BA(3)-SA-HRP -> (16) NP(3)-Binder-BA(4)-SA-HRP
